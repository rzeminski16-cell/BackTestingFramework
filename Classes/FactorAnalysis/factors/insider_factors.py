...
class InsiderFactors:
    ...
    def compute_all(
        ...
        new_cols = [c for c in trades_df.columns if c.startswith('insider_') and c not in self._factor_names]
