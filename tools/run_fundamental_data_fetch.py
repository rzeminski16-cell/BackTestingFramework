...
Usage:
    ...
    python run_fundamental_data_fetch.py logs/YourStrategy

    # With custom date range
    python run_fundamental_data_fetch.py logs/YourStrategy --start-year 2015 --end-year 2024

    # With custom output directory
    python run_fundamental_data_fetch.py logs/YourStrategy -o analysis_output/fundamentals

    # With custom config file
    python run_fundamental_data_fetch.py logs/YourStrategy --config my_config.json
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  %(prog)s logs/YourStrategy
  %(prog)s logs/YourStrategy --start-year 2015 --end-year 2024
  %(prog)s logs/YourStrategy -o analysis_output/fundamentals
